 ...
 */
export async function generateMigrationSpec(projectInfo, options) {
 ...
 */
function generateHeader(appName, projectInfo) {
 ...
 */
function generateCapacitorSetup(projectInfo, appName, bundleId) {
 ...
 */
function generateFrameworkSpecificSteps(projectInfo) {
    if (projectInfo.framework === 'nextjs') {
 ...
 */
function generateNextJsSteps(projectInfo) {
    if (projectInfo.framework !== 'nextjs')
        return '';
 ...
 */
function generateViteSteps(projectInfo) {
    if (projectInfo.framework !== 'vite')
        return '';
 ...
 */
function generateCRASteps(projectInfo) {
    if (projectInfo.framework !== 'cra')
        return '';
 ...
 */
function generateCommonIssues(_projectInfo) {
 ...
 */
function generateBuildSteps(projectInfo) {
 ...
 * Generate next steps
 */
function generateNextSteps(primaryColor) {
    return `## Next Steps
