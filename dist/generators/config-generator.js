 ...
 */
export function generateCapacitorConfig(options) {
 ...
 */
export function generateCapacitorScripts(framework) {
 ...
 */
export function generateInfoPlistPermissions() {
 ...
 */
export function generateGitignoreEntries() {
    return `# Capacitor
ios/
android/
*.xcworkspace
 ...
 */
export function generateSetupGuide(options) {
