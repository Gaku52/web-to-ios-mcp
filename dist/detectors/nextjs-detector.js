 ...
 */
export async function detectNextJsProject(projectPath) {
 ...
 */
async function detectApiRoutes(projectPath, routerType) {
    if (routerType === 'pages') {
 ...
 * Detect if static export is configured
 */
async function detectStaticExport(projectPath) {
    const configNames = [
        'next.config.js',
        'next.config.mjs',
        'next.config.ts',
...
//# sourceMappingURL=nextjs-detector.js.map