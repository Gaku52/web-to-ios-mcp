 ...
 */
export async function detectViteProject(projectPath) {
    ...
    const hasVueRouter = !!(packageJson.dependencies?.['vue-router'] ||
 ...
 * Find Vite config file
 */
async function findViteConfig(projectPath) {
    const configNames = [
        'vite.config.ts',
        'vite.config.js',
        'vite.config.mjs',
 ...
 */
async function detectBuildOutputDir(projectPath, viteConfigPath) {
...
//# sourceMappingURL=vite-detector.js.map