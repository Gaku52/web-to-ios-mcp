                ...
                tools: [
                    {
                        ...
                        description: 'Detect the web framework used in a project (Vite, Next.js, CRA). Returns framework type, version, and build configuration.',
                        inputSchema: {
                            type: 'object',
                            properties: {
                                projectPath: {
                    ...
                    },
                    {
                        ...
                        description: 'Generate a detailed iOS migration specification document based on the detected framework.',
                        inputSchema: {
                            type: 'object',
                            properties: {
                                projectPath: {
                                ...
                                primaryColor: {
                                    type: 'string',
                                    description: 'Optional: Primary color in hex format (e.g., "#8b5cf6")',
                                },
                            },
                    ...
                    },
                    {
                        ...
                        description: 'Generate a Capacitor configuration file (capacitor.config.ts) optimized for the detected framework.',
                        inputSchema: {
                            type: 'object',
                            properties: {
                                appName: {
                                ...
                                webDir: {
                                    type: 'string',
                                    description: 'Build output directory (e.g., "dist", "out", "build")',
                                },
                                framework: {
                                    type: 'string',
